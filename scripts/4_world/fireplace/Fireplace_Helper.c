class DMP_Fireplace_Helper 
{
    ...
    static ref array<typename> AllowedFireplaces = {dmp_stove_Base};
    ...
    static bool CanAddOvenIndoor( PlayerBase player, ActionTarget target)
    {
        ...
        {
            return dmpCanAddFireplace(player, target, action_selection);
        }
    ...
    static bool dmpCanAddFireplace(PlayerBase player, ActionTarget target, string action_selection)
	{
                ...
                {			
                    ...
                    if (CanPlaceFireplaceInSelectedSpot(fireplace_building, fire_point_pos_world, fire_point_rot_world))
                    {
                        ...
                        if (fire_point_dist <= 2)
                        {
                            ...
                            DMP_OpenableFurniture dmp_building = DMP_OpenableFurniture.Cast( fireplace_building );
                            if(dmp_building)
                            {
                                dmp_building.pickable = false;
                            }
                            return true;
                        }
                    }
